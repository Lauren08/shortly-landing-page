<template>
  <header class="header">
    <svg class="header__logo" aria-labelledby="header__logo" xmlns="http://www.w3.org/2000/svg" width="121" height="33">
      <path
        fill="#34313D"
      ...
      />
      <title id="header__logo">Shortly</title>
    </svg>
    <svg
      xmlns="http://www.w3.org/2000/svg"
      class="header__menu"
      aria-labelledby="header__menu"
      :aria-pressed="pressed"
      tabindex="0"
      v-on:click="handleMenu($event)"
      v-on:keyup.space="handleMenu($event)"
      width="32"
      height="32"
    >
      <path
      ...
      />
      <title id="header__menu">Menu</title>
    </svg>
    <nav v-if="pressed" class="header__nav">
      <ul>
        <li>
          <a href="#">Features</a>
        </li>
