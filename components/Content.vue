<template>
  <div class="-mt-20 pt-20 bg-neutral-lightgray">
      ...
      <div class="flex my-24 justify-center">
        ...
        <div class="flex flex-col relative">
          <div class="brand-card">
            ...
            <h3 class="brand-heading">Brand Recognition</h3>
          ...
          <div class="brand-card">
            ...
            <h3 class="brand-heading">Detailed Records</h3>
            <p class="brand-content">
          ...
          <div class="brand-card">
            ...
            <h3 class="brand-heading">Fully Customizable</h3>
            <p class="brand-content">
...
<script>
import ShortLinks from "./ShortLinks.vue";
...
.brand-icon {
  @apply absolute top-0 -mt-12 p-6 self-center rounded-full bg-darkvoilet;
}

.brand-heading {
  @apply mt-8 mb-4 self-center text-xl font-bold;
}

.brand-content {
  @apply self-center leading-xl text-center text-neutral-gray text-tiny font-semibold;
}

.blue-line {
  @apply h-full w-2 bg-cyan;
}
</style>
