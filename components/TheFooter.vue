  ...
  <footer class="flex max-w-full md:justify-center py-10 md:py-16 bg-neutral-verydarkvoilet">
    ...
    >
      <svg
        ...
        height="33"
      >
        <title id="footer-logo">Shortly</title>
        <path
          fill="#FFFFFF"
      ...
      <div class="flex flex-col md:flex-row md:justify-between md:w-9/12 lg:w-8/12">
        <div class="flex flex-col md:flex-row md:justify-between md:w-8/12">
          <ul class="mb-6 md:mb-0 text-white">
            <li>
              <h5 class="mb-4 leading-2xl text-small tracking-tight font-bold">Features</h5>
            </li>
            <li class="md:mt-1">
              <a
                class="text-neutral-gray text-tiny font-medium tracking-tight hover:text-cyan focus:outline-none focus:shadow-outline"
                href="#"
              >Link Shortening</a>
            </li>
            <li class="md:mt-1">
          ...
          <ul class="mb-6 md:mb-0 text-white mt-1 md:mt-0">
            <li>
              <h5 class="mb-4 leading-2xl text-small tracking-tight font-bold">Resources</h5>
            </li>
            <li class="md:mt-1">
              <a
                class="text-neutral-gray text-tiny font-medium tracking-tight hover:text-cyan focus:outline-none focus:shadow-outline"
          ...
          <ul class="mb-6 md:mb-0 text-white mt-1 md:mt-0">
            <li>
              <h5 class="mb-4 leading-2xl text-small tracking-tight font-bold">Company</h5>
            </li>
            <li class="md:mt-1">
              <a
                class="text-neutral-gray text-tiny font-medium tracking-tight hover:text-cyan focus:outline-none focus:shadow-outline"
        ...
        <ul class="flex justify-between items-center md:mt-1 w-40 md:w-32 h-full">
          <li class="focus-within:shadow-outline">
            <a
              class="text-white hover:text-cyan focus:outline-none"
          ...
          <li class="focus-within:shadow-outline">
            <a
              class="text-white hover:text-cyan focus:outline-none"
              aria-labelledby="social-pinterest"
              href="#"
            >
              <svg class="fill-current" xmlns="http://www.w3.org/2000/svg" width="24" height="24">
