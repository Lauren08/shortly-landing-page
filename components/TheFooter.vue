<template>
  <footer
    class="flex flex-col md:flex-row md:flex-wrap py-12 text-center items-center bg-neutral-verydarkvoilet"
  >
    <svg
      class="mb-12"
    ...
    <ul class="social">
      <li>
        <a aria-labelledby="social-facebook" href="#">
      ...
      <li>
        <a aria-labelledby="social-twitter" href="#">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">
      ...
      <li>
        <a aria-labelledby="social-pinterest" href="#">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">
      ...
      <li>
        <a aria-labelledby="social-instagram" href="#">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">
...
<style scoped>
h5 {
  @apply mb-4 leading-2xl text-small font-bold;
}
...
.social {
  @apply flex justify-between w-40;
}
