<template>
  <footer
    class="flex max-w-full md:justify-center py-10 md:py-16 bg-neutral-verydarkvoilet"
  >
    <div
    ...
    >
      ...
      <div
        class="flex flex-col md:flex-row md:justify-between md:w-9/12 lg:w-7/12"
      >
        <div class="flex flex-col md:flex-row md:justify-between md:w-8/12">
          <ul class="mb-6 md:mb-0 text-white">
            <li>
              <h5 class="mb-4 leading-2xl text-small tracking-tight font-bold">
                Features
              </h5>
            </li>
            <li class="md:mt-1">
        ...
        <ul
          class="flex justify-between items-center md:mt-1 w-40 md:w-32 h-full"
        >
