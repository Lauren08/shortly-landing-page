<template>
  ...
  >
    <div class="lg:order-last">
      ...
      <svg
        class="block pl-6 lg:pl-0 pb-5 lg:pb-0 h-64 lg:h-90 mx-auto lg:mx-0"
    ...
    <div class="flex flex-col lg:w-2/3 lg:flex-shrink-0 justify-center">
      <h1
        class="w-11/12 mt-5 md:mt-0 py-2 mx-auto lg:mx-0 text-4xl lg:text-5xl leading-4xl lg:leading-5xl text-center lg:text-left font-bold"
      >More than just shorter links</h1>
      <p
        class="w-11/12 mx-auto lg:mx-0 lg:text-xl leading-2xl lg:leading-3xl text-center lg:text-left text-neutral-grayishvoilet font-medium"
      >
...
<style scoped>
.hero-btn {
  @apply h-12 mt-8 mb-4 rounded-full;
}
