<template>
  <div
    class="flex flex-col lg:flex-row w-full lg:max-w-screen-lg h-auto mt-6 lg:mt-16 lg:mx-auto overflow-hidden lg:overflow-visible"
  >
    <div class="lg:order-last">
      <!-- #region mainpage image -->
      <svg
        class="block pl-8 lg:pl-0 pb-5 lg:pb-0 h-64 lg:h-90 mx-auto lg:mx-0"
    ...
    <div class="flex flex-col lg:w-7/12 lg:flex-shrink-0 justify-center">
      <h1
        class="w-11/12 lg:w-full mt-5 md:mt-0 py-2 mx-auto lg:mx-0 text-neutral-verydarkblue text-4xl lg:text-5xl leading-4xl lg:leading-5xl tracking-tightest text-center lg:text-left font-bold"
      >
        More than just shorter links
      </h1>
      <p
        class="w-11/12 md:w-10/12 lg:w-10/12 mx-auto lg:mx-0 text-neutral-grayishvoilet lg:text-xl leading-2xl lg:leading-3xl text-center lg:text-left tracking-wide font-medium"
      >
...
<style scoped>
.hero-btn {
  @apply h-12 mt-6 mb-4 rounded-full;
}
